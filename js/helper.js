...
var HTMLskillsStart = '<h3 id="skillsH3" class="green-text">Skills at a Glance:</h3><ul id="skills" class="flex-box"></ul>';
...
var HTMLprojectStart = '<ul class="project-entry gallery"></ul>';
var HTMLprojectItem = '<li class="flex-item">%data%</li>';
var HTMLprojectTitle = '<a href="#">%data%</a>';
var HTMLprojectDates = '<div class="projectDateText">%data%</div>';
 ...
 */
  function CenterControl(controlDiv, map) {
    ...
    controlText.innerHTML = 'Places Lived';
